...
#Se importa el archivo excel con los datos.
archivos <- readxl::read_excel("Ordenes-de-compra-2018-2019.xlsx")

#Se crea la grafica por Modalidad
ggplot2::ggplot(archivos,aes(x=Modalidad)) + geom_bar(fill="blue")
...
#Se importa el archivo excel con los datos.
archivoss <- readxl::read_excel("Estudiantes Beneficiados con Utileria Escolar 2020.xlsx")

#Se crea la grafica por Tanda
ggplot2::ggplot(archivoss,aes(x=TANDA)) + geom_bar(fill="blue")
